...
import { SponsorManager } from "@/components/sales/SponsorManager";
      ...
      <div className="max-w-7xl mx-auto space-y-3 md:space-y-4">
        ...
        <Tabs defaultValue="forecasts" className="space-y-4">
          <TabsList className="grid w-full grid-cols-2 lg:w-[400px]">
            <TabsTrigger value="forecasts">Previsión de Ventas</TabsTrigger>
            <TabsTrigger value="sponsors">Patrocinios & Marcas</TabsTrigger>
          </TabsList>

          <TabsContent value="forecasts" className="space-y-4 animate-in fade-in slide-in-from-left-4 duration-300">
