  ...
  return (
    <Sidebar collapsible="icon" className={cn("border-r border-sidebar-border transition-all duration-300", collapsed ? "w-14" : "w-56")}>
      ...
      <SidebarContent className="overflow-y-auto">
        {/* Action buttons */}
        <div className={cn("px-2 py-2", collapsed ? "space-y-1.5" : "flex gap-1.5")}>
          <Tooltip delayDuration={0}>
            <TooltipTrigger asChild>
              <Button 
                ...
                size="sm"
                className={cn(
                  "bg-gradient-to-r from-primary to-primary/80 hover:from-primary/90 hover:to-primary/70 text-primary-foreground shadow-sm h-8", 
                  collapsed ? "w-full p-0" : "flex-1 px-3"
                )}
              >
                <Sparkles className="h-4 w-4" />
                {!collapsed && <span className="text-xs font-semibold ml-1.5">Probar</span>}
              </Button>
            </TooltipTrigger>
            {collapsed && (
              <TooltipContent side="right" className="z-50">
          ...
          <Tooltip delayDuration={0}>
            <TooltipTrigger asChild>
              <Button 
                ...
                size="sm"
                className={cn(
                  "border-primary/30 hover:bg-primary/10 hover:border-primary/50 h-8", 
                  collapsed ? "w-full p-0" : "flex-1 px-3"
                )}
              >
                <MessageCircle className="h-4 w-4 text-primary" />
                {!collapsed && <span className="text-xs font-medium text-primary ml-1.5">Chat IA</span>}
              </Button>
            </TooltipTrigger>
            {collapsed && (
              <TooltipContent side="right" className="z-50">
        ...
        <SidebarGroup className="py-1">
          {!collapsed && (
            <SidebarGroupLabel className="text-[11px] text-sidebar-foreground/60 px-3 py-1 h-6">
              Festival
            </SidebarGroupLabel>
          )}
          <SidebarGroupContent>
